...
export default function Home({ coinListData }) {
  ...
  I'm down to join your talanted team, and I hope you liked this small project.
  `,
  ...
  return (
    <div>
      ...
      <Main>
        <h1 className="mb-4 animate-fade font-space text-3xl font-black text-primary md:text-4xl">
          Crypto Stake•fish
        </h1>
